...
- первый отдельный `repository/service`-слой для эксплуатационной диагностики;
...
- автоматические копии и контроль качества медиа подключены к общему runtime-контру.
