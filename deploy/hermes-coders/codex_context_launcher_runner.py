...
def execution_started_from_evidence(
    ...
    event_started = (
        ...
        and last_event.get("execution_started") is True
    )
    return bool(
...
class ContextLauncherTierProviderManager(
    CodexImageSupport,
...
def main() -> int:
    ...
    from codex_first_runner import ThreadingHTTPServer

    server = ThreadingHTTPServer((host, port), ImageHandler)
