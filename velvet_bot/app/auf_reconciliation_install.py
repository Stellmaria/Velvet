...
from velvet_bot.domains.auf_wallet import AufPurchaseRepository
...
def install_auf_reconciliation() -> None:
    ...
    def build_worker_manager_with_reconciliation(*args: Any, **kwargs: Any):
        ...
        if database is None or bot is None:
            return manager
        repository = AufPurchaseRepository(database)
...
__all__ = ("install_auf_reconciliation",)
