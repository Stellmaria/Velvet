...
def install_ai_model_routing() -> None:
    ...
    The patch is intentionally applied at application configuration time, before
    workers or Telegram handlers create any AI clients. Existing client classes
    keep their schemas and prompts, while model availability and fallback become
    shared infrastructure instead of duplicated controller logic.
    """
