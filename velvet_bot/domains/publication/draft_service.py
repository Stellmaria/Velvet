...
class PublicationDraftService:
    """Create and edit publication drafts using neutral inbox payloads."""
    ...
    async def create_from_payload(
        ...
        *,
        ...
        return await self._validator(draft.id, payload.owner_id)
    ...
    async def retry(self, draft_id: int, *, owner_id: int) -> PublicationDraft:
        await self._commands.retry(draft_id, owner_id=owner_id)
        return await self._validator(draft_id, owner_id)
