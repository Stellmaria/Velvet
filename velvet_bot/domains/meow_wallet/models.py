...
class MeowWalletStatus(StrEnum):
    ACTIVE = "active"
    FROZEN = "frozen"


class MeowWalletOperation(StrEnum):
    GRANT = "grant"
    PURCHASE = "purchase"
    RESERVE = "reserve"
    RELEASE = "release"
...
@dataclass(frozen=True, slots=True)
class MeowWalletOverview:
    wallet: MeowWallet
    spent_30d_units: int
    recent_entries: tuple[MeowWalletEntry, ...]


class MeowWalletError(RuntimeError):
    pass


class MeowWalletFrozen(MeowWalletError):
    pass


class MeowInsufficientBalance(MeowWalletError):
