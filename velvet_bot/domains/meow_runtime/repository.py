...
class MeowRuntimeRepository:
    def __init__(self, database: Database) -> None:
        self._database = database

    async def runtime_settings(self) -> MeowRuntimeSettings:
    ...
    async def confirm_runtime_settings(self, *, updated_by_user_id: int) -> MeowRuntimeSettings:
        async with self._database.acquire() as connection:
            row = await connection.fetchrow(
                """
                UPDATE meow_runtime_settings
    ...
    async def workspace_settings(self, workspace_id: int) -> WorkspaceMeowSettings:
        async with self._database.acquire() as connection:
            row = await connection.fetchrow(
                """
    ...
    async def provider_snapshot(self, provider: MeowProvider) -> MeowProviderSnapshot:
...
def _runtime_from_row(row: Mapping[str, Any]) -> MeowRuntimeSettings:
    return MeowRuntimeSettings(
...
def _workspace_from_row(row: Mapping[str, Any]) -> WorkspaceMeowSettings:
    return WorkspaceMeowSettings(
