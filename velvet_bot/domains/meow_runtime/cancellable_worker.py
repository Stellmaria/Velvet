...
class MeowCancellationRequested(RuntimeError):
...
def build_cancellable_worker_class(base_class: type[Any]) -> type[Any]:
    class CancellableMeowWorker(base_class):
        async def _prepare_provider_request(
            ...
            *,
            ...
            if (
                ...
                raise MeowCancellationRequested(
        ...
        async def _finish_terminal(
            ...
            *,
            ...
            cancellation_requested = isinstance(
                error, MeowCancellationRequested
    ...
    CancellableMeowWorker.__name__ = f"Cancellable{base_class.__name__}"
    CancellableMeowWorker.__qualname__ = CancellableMeowWorker.__name__
    return CancellableMeowWorker
