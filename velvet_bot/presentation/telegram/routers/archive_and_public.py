...
from velvet_bot.presentation.telegram.workspace_home_controller import (
    register_workspace_home,
)
from velvet_bot.presentation.telegram.workspace_reference_dashboard_controller import (
...
# Canonical workspace callbacks are bundle-level, so they win before the broad
# owner-controls child router without growing the router tree.
register_workspace_archive_dashboard(router)
register_workspace_home(router)
