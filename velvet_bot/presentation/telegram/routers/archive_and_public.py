...
from velvet_bot.presentation.telegram.routers.workspace_delete import (
    router as workspace_delete_router,
)
from velvet_bot.presentation.telegram.routers.workspace_quick_setup import (
    router as workspace_quick_setup_router,
)
...
# Quick setup must intercept the first workspace-name response before the older
# onboarding and legacy workspace handlers. Deletion must also run before broad routes.
router.include_router(workspace_quick_setup_router)
router.include_router(workspace_delete_router)
# Workspace onboarding must own setup/binding commands before broad handlers.
