...
async def handle_workspace_rework_action(
    ...
    repository = MediaReworkRepository(database, workspace_id=workspace.id)
...
router.callback_query.register(
    ...
    WorkspacePersonalArchiveCallback.filter(F.action == "rework"),
)
router.callback_query.register(
    handle_workspace_public_visibility_action,
    WorkspacePersonalArchiveCallback.filter(F.action == "public"),
)
