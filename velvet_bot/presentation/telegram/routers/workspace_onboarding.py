...
=======
        ...
        "chat_id, текущую тему, ссылку и проверит свои права. Это единственный "
        "шаг с командой: Telegram передаёт текущий чат и ветку только сообщением "
        "из этого места.\n\n"
        "Все остальные ежедневные действия открывайте кнопками из «Моё пространство». "
        "Команды <code>/workspace_setup</code> и <code>/workspace_setup_status</code> "
        "остаются запасным способом открыть мастер и проверить его состояние."
>>>>>>> Stashed changes
    )
