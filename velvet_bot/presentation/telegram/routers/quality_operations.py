...
from velvet_bot.presentation.telegram.routers.quality_operations_controllers.velvet_ai_pose_extractor import router as velvet_ai_pose_extractor_router
...
router.include_router(velvet_ai_pose_extractor_router)
