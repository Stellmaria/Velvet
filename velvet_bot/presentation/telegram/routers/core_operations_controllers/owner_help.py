...
OWNER_COMMAND_GROUPS: tuple[
    ...
    (
        ...
        (
            ...
            ("auf", "открыть генерацию фото и видео активного пространства"),
        ),
    ),
    (
        "Пользователи и вельветы",
        (
            ("velvet_grant", "начислить вельветы по Telegram ID или @username"),
            ("velvet_markup", "установить, проверить или сбросить персональную наценку"),
            ("velvet_user", "показать карточку и активность пользователя"),
            ("velvet_users", "показать последних активных пользователей"),
        ),
    ),
    (
    ...
    (
        ...
        (
            ...
            ("storage_librarian", "показать состояние Hermes-разбора Storage"),
            ("storage_analyze", "проанализировать Storage object по ID"),
            ("storage_digest", "показать сводку проанализированных объектов"),
            ("storage_ask", "задать вопрос по индексу Telegram Storage"),
