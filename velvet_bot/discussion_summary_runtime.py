...
from velvet_bot.analytics_dashboard import period_since
from velvet_bot.database import Database
from velvet_bot.discussion_insights import DiscussionSummary
...
async def get_discussion_summary(
    ...
    *,
    ...
    """Return the Phase 5 discussion summary without ambiguous CTE columns."""
