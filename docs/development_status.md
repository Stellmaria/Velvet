...
- регрессионный тест запрещает возврат приватного pool access во всех семи завершённых доменах;
...
Следующий срез: `DiscussionRepository`.
...
1. Продолжить Фазу 18 с `DiscussionRepository`; characters, stories, archive, public archive, references, media quality и publication завершены.
