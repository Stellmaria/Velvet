...
Статус: срезы 18A–18AE реализованы, работа продолжается.
...
Следующий срез: **18AF, alias management**, 2 connection points. Ожидаемый baseline: 58 обращений в 14 файлах.
