...
Статус: срезы 18A–18O реализованы, работа продолжается.
...
- SQL и параметры;
- owner scope;
- транзакции и event logging;
- блокировки и пагинация;
- mapping domain-моделей.
...
Следующий срез: **18P, `PublicationDraftRepository`**, 8 connection points. Ожидаемый baseline: 118 обращений в 32 файлах.
...
1. Фаза 18P: `PublicationDraftRepository`.
2. `SystemRepository` отдельным срезом.
