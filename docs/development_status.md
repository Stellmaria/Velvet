...
Статус: срезы 18A–18AF реализованы, работа продолжается.
...
Следующий срез: **18AG, character aliases**, 5 connection points. Ожидаемый baseline: 53 обращения в 13 файлах.
