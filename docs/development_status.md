...
Статус: срезы 18A–18T реализованы, работа продолжается.
...
- runtime diagnostics;
- prompt/result и palette/composition report arguments;
- `FormattingMode`, исходный и итоговый текст оформления;
- provider/model limits, JSON payload и created_by;
...
Следующий срез: **18U, `QualityCalibrationRepository`**, 3 connection points. Ожидаемый baseline: 110 обращений в 27 файлах.
...
1. Фаза 18U: `QualityCalibrationRepository`.
