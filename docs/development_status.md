...
Статус: срезы 18A–18Z реализованы, работа продолжается.
...
Следующий срез: **18AA, backup runtime**, 2 connection points. Ожидаемый baseline: 82 обращения в 20 файлах.
...
1. Фаза 18AA: backup runtime.
2. Фаза 18AB: backup service.
