...
Статус: срезы 18A–18AA реализованы, работа продолжается.
...
- backup expected-table decode и timezone/date schedule check.
...
Следующий срез: **18AB, базовый backup service**, 15 connection points. Ожидаемый baseline: 67 обращений в 19 файлах.
...
1. Фаза 18AB: базовый backup service.
