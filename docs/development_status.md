...
Статус: срезы 18A–18AK реализованы, работа продолжается.
...
Следующий срез: **18AL, media sets**, 9 connection points. Ожидаемый baseline: 14 обращений в 8 файлах.
...
1. Фаза 18AL: media sets.
2. Завершить перенос application/presentation DB access отдельными архитектурными срезами.
