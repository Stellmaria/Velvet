...
- активных router imports в bundles: **83**;
...
- `velvet_bot/presentation/telegram/routers/archive_and_public.py`: 52 routers.
- `velvet_bot/presentation/telegram/routers/core_operations.py`: 8 routers.
- `velvet_bot/presentation/telegram/routers/quality_operations.py`: 16 routers.
