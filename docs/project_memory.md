...
Статус: срезы 18A–18O реализованы, baseline продолжает уменьшаться.
...
Следующий срез: **18P, `PublicationDraftRepository`**, 8 connection points.
...
1. Фаза 18P: `PublicationDraftRepository`, baseline 126 → 118.
2. Затем `SystemRepository` отдельным срезом.
