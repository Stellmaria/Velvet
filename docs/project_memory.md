...
Статус: срезы 18A–18P реализованы, baseline продолжает уменьшаться.
...
- SQL и транзакционные границы завершённых repositories сохранены.

Следующий срез: **18Q, `SystemRepository`**, 2 connection points.
...
1. Фаза 18Q: `SystemRepository`, baseline 118 → 116.
2. Затем переводить repository-классы AI/quality/error/report отдельными срезами.
