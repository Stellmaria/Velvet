...
Активные adapters находятся в одном pre-import/post-import реестре. Отдельный legacy-consumer inventory фиксирует 20 production-файлов, 30 references и 18 старых handler modules после очистки первых character/story controllers. Каждый alias удаляется только после переноса consumers на канонический service/view/repository и регрессионной проверки.
