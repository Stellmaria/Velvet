...
Пересчитать package architecture inventory штатным генератором, получить зелёный CI, затем после отдельного разрешения владельца слить PR #544 и выполнить production smoke-test.
