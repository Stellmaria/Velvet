...
- repository layout inventory регенерирован на GitHub runner с Python 3.13 и label `p3e-repository-layout-complete` после добавления production consumer recovery helper;
