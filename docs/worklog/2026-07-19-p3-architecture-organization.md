...
- попытки #918/#455/#320 завершились до первого workflow step без checkout и без logs, поэтому классифицированы как инфраструктурный сбой GitHub Actions, а не результат проверки кода.
