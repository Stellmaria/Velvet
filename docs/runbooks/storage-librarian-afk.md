...
`AUTO_MIN_OBJECT_ID=0` при включённом AFK считается ошибкой конфигурации. Scheduler не стартует, чтобы исключить случайную постановку всего старого архива в очередь.
