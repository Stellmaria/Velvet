...
class PublicArchiveBoundaryTests(unittest.IsolatedAsyncioTestCase):
    def setUp(self) -> None:
        self.original_prepare = module._prepare_media
    ...
    def tearDown(self) -> None:
        module._prepare_media = self.original_prepare
    ...
    def _set_prepared(self, *, member_access: bool) -> None:
        async def prepare(*args, **kwargs):
            return module._PreparedMedia(
                page=self.page,
                manager_access=False,
                member_access=member_access,
            )

        module._prepare_media = prepare
    ...
    async def test_nonmember_without_approved_watermark_is_denied(self) -> None:
        self._set_prepared(member_access=False)
    ...
    async def test_member_receives_original_and_download_is_recorded(self) -> None:
        ...
        self._set_prepared(member_access=True)
