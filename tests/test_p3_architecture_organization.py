...
EXPECTED_ROUTER_MODULES = {
    ...
    "velvet_bot.presentation.telegram.routers.core_operations_controllers.workspace_admin_panel",
    ...
    "velvet_bot.presentation.telegram.routers.user_management",
    ...
    "velvet_bot.presentation.telegram.routers.workspace_member_home",
