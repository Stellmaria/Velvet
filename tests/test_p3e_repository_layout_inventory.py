...
class P3ERepositoryLayoutInventoryTests(unittest.TestCase):
    ...
    def test_repository_layout_migration_is_complete(self) -> None:
        ...
        self.assertEqual(7, inventory["layout_counts"]["infrastructure"])
